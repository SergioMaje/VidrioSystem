...
import { Loader2, Plus, Search, ShoppingCart, Trash2, TriangleAlert } from 'lucide-react'
...
/**
 * Venta de mostrador. Se monta solo con un turno de caja abierto: la sesión la
 * resuelve `CajaPage`, y el RPC `registrar_venta_mostrador` la vuelve a exigir
 * en Postgres, que es donde está la garantía real.
 */
